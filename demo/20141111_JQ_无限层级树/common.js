...
$.fn.extend((function () {
    ...
    function tagsInput(params) {
        ...
        function addTag(v) {
            ...
            $('<span class="tag"><span>' + v + '</span><i data-id="' + time + '">x</i></span>').insertBefore(jIn);
        ...
        function importTags(tagNames) {
            ...
            $.each(tagNames.split(','), function (i, n) {
                addTag(n);
            });
    ...
    */
    ...
    c.Popup = function (params) {
        ...
        function getBoxHtml() {
            ...
            return '<div class="popup"><div class="bg"></div><div class="win">\
